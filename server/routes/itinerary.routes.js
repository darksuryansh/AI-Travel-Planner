...
import { sendItineraryUpdate } from '../services/kafkaProducer.js';
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (updates.parameters) {
      await cacheService.invalidateItinerary(updates.parameters);
    }
    
    // Notify collaborators via Kafka
    await sendItineraryUpdate({
      itineraryId,
      userId: uid,
      userName: name,
      action: 'updated',
